"use strict";$(function(){$(".reviews__slider").slick({dots:!0,arrows:!0,infinite:!1,autoplay:!0,autoplaySpeed:6e3,slidesToShow:3,slidesToScroll:1,prevArrow:$(".prev"),nextArrow:$(".next"),responsive:[{breakpoint:1616,settings:{arrows:!1}},{breakpoint:1111,settings:{slidesToShow:2,slidesToScroll:1,arrows:!1}},{breakpoint:765,settings:{slidesToShow:1,arrows:!1,slidesToScroll:1}}]}),$(".menu-burger__header").click(function(){$(".menu-burger__header").toggleClass("open-menu"),$(".header__nav").toggleClass("open-menu"),$("body").toggleClass("fixed-page")}),$(".popup-open").click(function(){return $(".popup-fade").fadeIn(),!1}),$(".popup-close").click(function(){return $(this).parents(".popup-fade").fadeOut(),!1}),$(document).keydown(function(e){27===e.keyCode&&(e.stopPropagation(),$(".popup-fade").fadeOut())}),$(".popup-fade").click(function(e){0==$(e.target).closest(".popup").length&&$(this).fadeOut()}),$("#phone").mask("+7 (999) 999-99-99"),$("#phone2").mask("+7 (999) 999-99-99"),$("#phone3").mask("+7 (999) 999-99-99")});
